...
export const Sidebar: React.FC = () => {
  ...
  // Debounced search handler (优化为 250ms)
  ...
  // 键盘快捷键 (Cmd+K / Ctrl+K 聚焦搜索, ESC 清除)
  useEffect(() => {
      ...
      <div className="p-4">
        <div className="relative group">
          ...
          <input
            ...
            className="w-full rounded-lg pl-9 pr-9 py-2 focus:outline-none focus:border-theme-accent transition-colors text-xs font-medium border bg-theme-input-bg border-theme-input-border text-theme-input-text placeholder-theme-input-placeholder"
            placeholder={t.sidebar.searchPlaceholder}
          />
          {searchQuery && (
            <button
              onClick={clearSearch}
              className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-theme-text-muted hover:text-theme-text-primary transition-colors"
